...
public class Bed {
    ...
    private Employee empdoc;
    
    private Employee empnur;
    ...
    public Employee getEmpdoc() {
		return empdoc;
	}

	public void setEmpdoc(Employee empdoc) {
		this.empdoc = empdoc;
	}

	public Employee getEmpnur() {
		return empnur;
	}

	public void setEmpnur(Employee empnur) {
		this.empnur = empnur;
	}
